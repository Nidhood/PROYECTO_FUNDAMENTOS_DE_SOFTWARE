...
public class Tienda {
    ...
    public UUID getPersonaltiendaid() {
        return personaltiendaid;
    }

    public void setPersonaltiendaid(UUID personaltiendaid) {
        this.personaltiendaid = personaltiendaid;
    }
